...
- **OCR/ICR**: Text extraction from scanned documents and images
- **Document Separation**: Automated splitting of multi-document files
- **Classification**: Content-based categorization of document types
- **Data Extraction**: Targeted location and retrieval of specific data fields
- **Redaction**: Identification and removal of sensitive information
- **Barcode Recognition**: Reading of linear and 2D barcodes for document routing
- **Validation Web UI**: Interface for document review and quality assurance
- **Analytics Dashboard**: Performance monitoring and processing metrics
...
| Uptime | claimed 99%+ availability |
...
Contact: [Contact Page](https://aluma.io/contact)
